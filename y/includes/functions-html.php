...
function yourls_html_logo() {
	...
	?>
	<h1>
		<a href="<?php echo yourls_admin_url('index.php') ?>" title="YOURLS"><span>TERMINAT[ORG]</span> URL Shortener<br/>
		<img src="<?php yourls_site_url(); ?>/images/tlogo.jpg" alt="YOURLS" title="YOURLS" border="0" style="border: 0px;" /></a>
	</h1>
	<?php
...
function yourls_html_head( $context = 'index', $title = '' ) {
	...
	// Page title
	$_title = 'TERMINAT[ORG] URL Shortener | ' . YOURLS_SITE;
