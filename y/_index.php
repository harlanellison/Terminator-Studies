<?php
	...
	// Start YOURLS engine..
	require_once( '../../yrl/includes/load-yourls.php' );
	...
	*/
	...
	$linked_list_url = $_REQUEST['linked_list_url'];
	...
	add_post_meta($post_ID, 'linked_list_url', $linked_list_url, false);
	}
	return $post_ID;
	}
	...
	if ( isset( $return['status'] ) && $return['status'] == 'fail' && isset( $return['code'] ) && $return['code'] == 'error:keyword' ) {
		...
		$keyword  = substr($shorturl, strlen(YOURLS_SITE)+1);
		...
		<p><a href="/png/$keyword.png"><img src="$thumb$keyword.png">$thumb $keyword</a></p>
...
?></textarea>
<h3>Link URL</h3>
<input name="linked_list_url" type="text" id="elink" class="mceEditor" style="width:100%;" value="<?php echo $url; ?>"/>
</div>
</div>
</div>
</div>
